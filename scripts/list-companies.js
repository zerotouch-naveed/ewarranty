...
console.log('⚠️  DEPRECATED: list-companies.js');
console.log('═══════════════════════════════════');
...
console.log('');
console.log('📊 View comprehensive system overview:');
...
console.log('');
console.log('❌ This script will not run and may provide incomplete information.');
process.exit(1);
